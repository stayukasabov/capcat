...
- [`core.conversion_executor`](./conversion_executor.md) - Shared executor pool for HTML-to-Markdown conversion to prevent nested ThreadPoolExecutor deadlock
- [`core.enhanced_argparse`](./enhanced_argparse.md) - Enhanced ArgumentParser with better error messages and validation
...
- [`core.cli_validation`](./cli_validation.md) - Enhanced CLI validation and error handling for better user experience
...
- [`core.cli_recovery`](./cli_recovery.md) - CLI error recovery and user guidance system
